...
class Insert:
    ...
    def POST_INSERT():
        ...
        # call model insert_registro_juego and try to insert new data
        config.model.insert_registro_juego(
            form['fecha_registro'],form['jugador_idjugador'],form['juego_idjuego'],form['logros_idlogros'],
        )
