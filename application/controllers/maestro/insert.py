...
class Insert:
    ...
    def POST_INSERT():
        ...
        # call model insert_maestro and try to insert new data
        config.model.insert_maestro(
            form['Nombre'],form['Ap_paterno'],form['Ap_materno'],form['Usuario'],form['idgrupo_grupo'],
        )
